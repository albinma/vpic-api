...
export interface AirBagLocation {
  Id: Generated<number>;
  Name: string;
}
...
export interface WmiYearValidChar {
  Char: string | null;
  id: Generated<number>;
...
export interface WmiYearValidCharsCacheException {
  CreatedOn: Generated<Date>;
  Id: Generated<number>;
  WMI: string;
}
...
export interface DB {
  ...
  AirBagLocations: AirBagLocation;
  ...
  WMIYearValidChars: WmiYearValidChar;
  WMIYearValidChars_CacheExceptions: WmiYearValidCharsCacheException;
}
